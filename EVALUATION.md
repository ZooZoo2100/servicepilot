...
| Full automated suite                        | 188 checks     | Includes 100 scenarios, 18 original authority-boundary checks, 5 original iteration checks, 42 verification/provider/client checks, 11 credential-safety checks and 12 public-hosting checks; **not 188 independent conversation scenarios** |
| Browser suites                              | 18 tests       | 13 local tests plus 5 public-production checks; A–J demos, API boundaries, Lab, mobile, errors and temporary-session isolation                                                                                                               |
